import { BUTTON_CHECK, BUTTON_ERROR, BUTTON_SUBMIT, BUTTON_WAIT } from "../../utils/button-states"
...
export const formReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case formActionTypes.SUBMIT_FAIL:
      return { ...state, buttonType: BUTTON_ERROR, error: action.payload.error, canSubmit: true }
